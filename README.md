...
`sqlui-native` is a cross-platform desktop SQL/NoSQL database client and REST API client built with Tauri 2 and Rust. It supports MySQL, MariaDB, Microsoft SQL Server, PostgreSQL, SQLite, Cassandra, MongoDB, Redis, Azure CosmosDB, Azure Table Storage, Salesforce, REST API (curl/fetch), and GraphQL.
