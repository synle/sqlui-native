...
/** Mustache template for a Python code snippet connecting to Salesforce via simple-salesforce. */
export const sfdc = `\
# python3 -m venv ./ # setting up virtual environment
# source bin/activate # activate the venv profile
