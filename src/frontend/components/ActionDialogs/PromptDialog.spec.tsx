...
describe("PromptDialog", () => {
  ...
  test("renders the title", () => {
    const { container } = render(
      <PromptDialog open={true} message="msg" title="My Prompt" onSaveClick={() => {}} onDismiss={() => {}} />,
    );
  ...
  test("renders default title 'Prompt' when none given", () => {
    const { container } = render(
      <PromptDialog open={true} message="msg" onSaveClick={() => {}} onDismiss={() => {}} />,
    );
  ...
  test("renders save button with custom label", () => {
    const { container } = render(
      <PromptDialog open={true} message="msg" saveLabel="Apply" onSaveClick={() => {}} onDismiss={() => {}} />,
    );
  ...
  test("renders default save label 'Save Changes'", () => {
    const { container } = render(
      <PromptDialog open={true} message="msg" value="something" onSaveClick={() => {}} onDismiss={() => {}} />,
    );
