...
describe("AlertDialog", () => {
  test("renders the message text", () => {
    const { container } = render(<AlertDialog open={true} message="Something happened" onDismiss={() => {}} />);
    expect(container.textContent).toContain("Something happened");
  });

  test("renders default title 'Alert'", () => {
    const { container } = render(<AlertDialog open={true} message="msg" onDismiss={() => {}} />);
    expect(container.textContent).toContain("Alert");
  });

  test("renders custom title", () => {
    const { container } = render(<AlertDialog open={true} message="msg" title="Custom Title" onDismiss={() => {}} />);
  ...
  test("renders Yes/No buttons for confirm mode", () => {
    const { container } = render(<AlertDialog open={true} message="msg" isConfirm={true} onDismiss={() => {}} />);
  ...
  test("calls onYesClick when Yes is clicked in confirm mode", () => {
    ...
    const { container } = render(<AlertDialog open={true} message="msg" isConfirm={true} onYesClick={onYesClick} onDismiss={() => {}} />);
  ...
  test("renders nothing visible when open is false", () => {
    const { container } = render(<AlertDialog open={false} message="hidden msg" onDismiss={() => {}} />);
